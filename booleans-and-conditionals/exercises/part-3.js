...
If fuelLevel is above 20000 AND engineIndicatorLight is NOT red blinking OR commandOverride is true print "Cleared to launch!" Else print "Cleared to launch!" Else print "Launch scrubbed!" */

if (fuelLevel > 20000 && engineIndicatorLight !== 'red blinking' || commandOverride === true) {
    console.log ("Cleared to launch!");
}if (fuelLevel < 20000 || commandOverride === false) {
